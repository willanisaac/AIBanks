...
export async function getChatResponse(messages, options = {}) {
  const CHATBOT_SYSTEM_INSTRUCTION = [
    ...
    "",
    "REGLAS DE FORMATO E IDIOMA (muy importante):",
    ...
    "5) IDIOMA: Detecta el idioma en el que te habla el usuario y responde estrictamente en ese mismo idioma (ej. si pregunta en inglés, responde en inglés; si en español, en español).",
    "",
    ...
    "• Códigos de referido (Compartir): Ve al Perfil (oprimiendo tu nombre arriba) > 'Compártelo y ambos ganan mAIles'. Ahí copias tu código para enviarlo a un amigo.",
    "• Códigos de referido (Ingresar): En la misma tarjeta inferior de 'Tu Código de Referido' está un campo para ingresar el código de algún amigo y ganar mAIles (no hace falta navegar a ningún otro lugar de la pantalla).",
    "",
